...
func (o *ListProjectEnvVarsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	case 404:
		result := NewListProjectEnvVarsNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewListProjectEnvVarsNotFound() *ListProjectEnvVarsNotFound {
	return &ListProjectEnvVarsNotFound{}
}
...
func (o *ListProjectEnvVarsNotFound) Error() string {
	return fmt.Sprintf("[GET /project/{project-slug}/envvar][%d] listProjectEnvVarsNotFound  %+v", 404, o.Payload)
}
...
func (o *ListProjectEnvVarsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
