...
func (o *AddProjectEnvVarReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	case 404:
		result := NewAddProjectEnvVarNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewAddProjectEnvVarNotFound() *AddProjectEnvVarNotFound {
	return &AddProjectEnvVarNotFound{}
}
...
func (o *AddProjectEnvVarNotFound) Error() string {
	return fmt.Sprintf("[POST /project/{project-slug}/envvar][%d] addProjectEnvVarNotFound  %+v", 404, o.Payload)
}
...
func (o *AddProjectEnvVarNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
