...
func (m *SchedulesInfo) validateItems(formats strfmt.Registry) error {
...
func (m *SchedulesInfo) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
