...
func (m *ContextsInfo) validateItems(formats strfmt.Registry) error {
...
func (m *ContextsInfo) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
