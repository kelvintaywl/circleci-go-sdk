...
func (o *UpdateScheduleParams) WithBody(body *models.SchedulePayload) *UpdateScheduleParams {
	o.SetBody(body)
	return o
}
...
func (o *UpdateScheduleParams) WithID(id strfmt.UUID) *UpdateScheduleParams {
	o.SetID(id)
	return o
}
