...
func (m *ProjectCheckoutKeysInfo) validateItems(formats strfmt.Registry) error {
...
func (m *ProjectCheckoutKeysInfo) contextValidateItems(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProjectCheckoutKeysInfo) UnmarshalBinary(b []byte) error {
	var res ProjectCheckoutKeysInfo
